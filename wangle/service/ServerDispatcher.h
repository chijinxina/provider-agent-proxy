...
/**
 * Dispatch requests from pipeline as they come in. 按照请求到来的顺序分发请求
 * Responses are queued until they can be sent in order. 响应排队，直到它们可以按照顺序发送
 */
template <typename Req, typename Resp = Req>
